...
static const int GW_SRAM_DATA PSGVolumeValues[16] = {
...
void gwenesis_SN76489_Reset()
{
    ...
    /* Upstream never sets the feedback taps, leaving the LFSR to shift in
       zeros: the white-noise channel (drums, sea, explosions) dies out.
       0x0009 = bits 0+3, the SMS2/Genesis tap pattern. */
...
static inline void GW_SRAM_FUNC(gwenesis_SN76489_Update)(INT16 *buffer, int length)
{
    int i, j;
...
void GW_SRAM_FUNC(gwenesis_SN76489_run)(int target) {
...
void GW_SRAM_FUNC(gwenesis_SN76489_Write)(int data, int target)
{
