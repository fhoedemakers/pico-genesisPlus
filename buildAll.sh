:
# ====================================================================================
# Pico-genesisPlus build all script 
# Builds the emulator for the default and alternate configuration.
# Only RP2350 (Pico 2) supported.
# Binaries are copied to the releases folder
#   - pico2_picogenesisPlusPimoroniDV.uf2     Pimoroni Pico DV Demo Base
#   - pico2_picogenesisPlusAdaFruitDVISD.uf2  AdaFruit HDMI and SD Breakout boards
# ====================================================================================
cd `dirname $0` || exit 1
...
HWCONFIGS="1 2 5 6 8 9 10 12 13"
for HWCONFIG in $HWCONFIGS
do
